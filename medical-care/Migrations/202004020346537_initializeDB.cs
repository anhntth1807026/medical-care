namespace medical_care.Migrations
{
    ...
    public partial class initializeDB : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.PolicyRequests", "Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.PolicyRequests", "Company_CompanyId", "dbo.Companies");
            ...
            DropIndex("dbo.PolicyRequests", new[] { "Company_CompanyId" });
            DropIndex("dbo.PolicyRequests", new[] { "PolicyId" });
            DropIndex("dbo.PolicyRequests", new[] { "Id" });
